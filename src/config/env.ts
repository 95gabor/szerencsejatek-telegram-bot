...
const envSchema = z.object({
  ...
  DENO_CRON_RESULT_CHECK_ENABLED: z.preprocess(parseBooleanEnv, z.boolean().default(false)),
...
function readRawEnv(): Record<string, string | undefined> {
  return {
    ...
    DENO_CRON_RESULT_CHECK_ENABLED: Deno.env.get("DENO_CRON_RESULT_CHECK_ENABLED"),
